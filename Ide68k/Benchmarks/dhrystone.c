...
#endif
	printf("Dhrystone (%s) time for %ld passes = %ld secs\n", Version, LOOPS, benchtime/HZ);
	printf("This (virtual) machine benchmarks at %ld dhrystones/second (%ld MIPS)\n",
		LOOPS * HZ / benchtime, LOOPS * HZ / benchtime / 1600);

...
*
* The timer interrupt is generated at a rate of approx. 100 times per second and increments
* the BAR display (0 to full-scale in +/- 2.56 seconds)
*
...
timerproc  addq.b  #1,BAR            incr. bar 100 times per sec
           rte
